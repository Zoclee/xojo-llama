...
3. Download the latest Llama binaries relevent for your machine architecture from https://github.com/ggml-org/llama.cpp/releases and extract the contents to the new bin/ folder.
4. In the XOJO IDE, delete the current CopyLlamaBinaries build step for your platform, and replace it with a new one that copies all the files in the bin/ folder (for both debug and release).

...
1. Check our xojo-llama to your local machine.
2. Create a bin/ folder next to the src/ folder.
3. Download the latest Llama binaries relevent for your machine from https://github.com/ggml-org/llama.cpp/releases and extract the content to the new bin folder.
